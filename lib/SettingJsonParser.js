...
class SettingJsonParser {
    ...
    configure (config, options, userElectronSettingsPath) {
        ...
        if (options) {
            this.package.browserWindow.webPreferences.devTools = !options.release || !!options?.devtools;
        }
        if (options && this.package.browserWindow.webPreferences.devTools) {
            this.package.browserWindow.webPreferences.showDevTools = !options.release;
        }
        return this;
    }
